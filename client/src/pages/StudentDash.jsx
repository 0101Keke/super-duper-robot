                ...
                <div className="row mb-4">
                    <div className="col">
                        <div className="d-flex justify-content-between align-items-center">
                            <div>
                                <h1 className="h2 text-dark mb-1">{getGreeting()}, {user?.fullName || user?.name || 'Student'}!</h1>
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="card border-0 shadow-sm mb-4">
                            <div className="card-header bg-white border-0 d-flex justify-content-between align-items-center py-3">
                                ...
                                <a href="/courses/my-courses" className="btn btn-sm btn-outline-primary">
                                    ...
                                    {courses.length > 0 ? (
                                        courses.map(course => (
                                            <div key={course.id} className="col-md-6 col-lg-4 mb-3">
                                                <div className="card h-100 border shadow-sm course-card" onClick={() => handleCourseClick(course.id)} style={{ cursor: 'pointer' }}>
                                                    <img src={course.thumbnail} className="card-img-top" alt={course.title} style={{ height: '140px', objectFit: 'cover' }} />
                                                    <div className="card-body">
